    ...
    <>
      ...
      <main className="mx-auto max-w-3xl px-4 py-16">
        ...
        <div className="prose dark:prose-invert max-w-none space-y-6 text-muted-foreground">
          <p>
            Hemfixloggen värnar om din personliga integritet. Denna policy
          ...
          <p>
            Dina uppgifter används enbart för att tillhandahålla Hemfixloggens
          ...
          <p>
            Har du frågor?{" "}
            <Link href="mailto:kontakt@hemfixloggen.se" className="text-primary hover:underline">
              Kontakta oss
            </Link>
          </p>
        </div>
