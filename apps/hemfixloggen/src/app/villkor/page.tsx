    ...
    <>
      ...
      <main className="mx-auto max-w-3xl px-4 py-16">
        ...
        <div className="prose dark:prose-invert max-w-none space-y-6 text-muted-foreground">
          <p>
            Genom att använda Hemfixloggen accepterar du dessa användarvillkor.
          </p>
          <h2 className="text-xl font-semibold text-foreground">Tjänsten</h2>
          <p>
            Hemfixloggen tillhandahåller ett verktyg för företag inom städ
            och trädgård att hantera uppdrag, fakturor och kundregister.
            Tjänsten erbjuds i befintligt skick.
          </p>
          ...
          <p>
            Hemfixloggen ansvarar inte för eventuella fel i genererade fakturor
