...
export function UppdragForm({ uppdragId, defaultValues, customers }: Props) {
  ...
  const rutAvdrag = watch("rutAvdrag");
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-1">
              ...
              <Select
                defaultValue={defaultValues?.uppdragsTyp ?? "stadning"}
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center gap-2 pt-2">
            <Checkbox
              id="rutAvdrag"
              checked={rutAvdrag}
              onCheckedChange={(v) => setValue("rutAvdrag", v === true)}
            />
            <Label htmlFor="rutAvdrag" className="font-normal">
              RUT-avdrag ska tillämpas
            </Label>
          </div>
        </CardContent>
      </Card>
